...
useEffect(() => {
  ...
  {!products ? (
    ...
    //  Actual Products --->>> 
      ...
      <div
        key={p._id}
        className={`p-4 sm:p-2 rounded shadow-md ${currentTheme.inputBg} hover:shadow-lg transition-shadow h-full flex flex-col border border-amber-300  ${currentTheme.text}
